              ...
              <Dialog open={isUploadModalOpen} onOpenChange={setIsUploadModalOpen}>
                ...
                <DialogContent className="max-w-2xl">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Upload files to your GitHub repository. Files will be accessible via CDN URLs.
                    </DialogDescription>
                  </DialogHeader>
                  <UploadZone />
                </DialogContent>
            ...
            <CardContent className="p-0">
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody>
                    {filteredFiles.map((file) => (
                      <tr key={file.id} className="border-b hover:bg-slate-50 dark:hover:bg-slate-800">
                        <td className="p-4">
